...
router.post('/', (0, authMiddleware_1.authorizeRole)(['ADMIN', 'GENERAL_MANAGER']), staffController_1.createStaffMember);
router.put('/:id', (0, authMiddleware_1.authorizeRole)(['ADMIN', 'GENERAL_MANAGER', 'BRANCH_MANAGER']), staffController_1.updateStaffMember);
router.delete('/:id', (0, authMiddleware_1.authorizeRole)(['ADMIN', 'GENERAL_MANAGER']), staffController_1.deleteStaffMember);
